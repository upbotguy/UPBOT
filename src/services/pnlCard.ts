...
export async function generatePnLCard(data: PnLCardData): Promise<Buffer> {
  ...
  <svg width="1200" height="675" viewBox="0 0 1200 675" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="header">
      ...
      <text x="120" y="76" font-family="system-ui, -apple-system, sans-serif" font-weight="800" font-size="22" fill="#FFFFFF" letter-spacing="1">UPBOT AI</text>
    ...
    <g id="footer">
      ...
      <text x="60" y="618" font-family="system-ui, -apple-system, sans-serif" font-weight="700" font-size="15" fill="#64748B">🚀 Generated by UPBOT AI Solana Trading Terminal</text>
      <text x="1140" y="618" font-family="system-ui, -apple-system, sans-serif" font-weight="800" font-size="15" fill="#9945FF" text-anchor="end">@${data.botUsername || 'sol_quickbot'}</text>
    </g>
  </svg>
  `;
